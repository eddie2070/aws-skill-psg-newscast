...
exports.handler =  (event, context, callback) => {
    ...
    var params = {from:'PSG_English', count: 10, tweet_mode: 'extended'}; // this is the param variable which will have key and value,the key is the keyword which we are interested in searching and count is the count of it
